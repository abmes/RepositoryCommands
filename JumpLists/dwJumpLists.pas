...
type
  ...
  private
    FDisplayKnowCategories
      : TJumpListKnowCategories;
    FDestinationList
...
begin
  ...
  begin
    ...
    Self.FShellItem.Assign((Source as TdwLinkObjectItem).FShellItem);
    Self.FShellLink.Assign((Source as TdwLinkObjectItem).FShellLink);
  end
  else
  begin
    inherited Assign(Source);
